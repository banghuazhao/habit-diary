...
extension DependencyValues {
    var insightsService: InsightsService {
        get { self[InsightsServiceKey.self] }
        set { self[InsightsServiceKey.self] = newValue }
    }
}

private enum InsightsServiceKey: DependencyKey {
    static let liveValue = InsightsService()
} 
