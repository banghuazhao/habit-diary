...
@Observable
class ReminderNotificationCenter {
...
extension DependencyValues {
    var reminderNotificationCenter: ReminderNotificationCenter {
        get { self[ReminderNotificationCenterKey.self] }
        set { self[ReminderNotificationCenterKey.self] = newValue }
    }
}

private enum ReminderNotificationCenterKey: DependencyKey {
    static let liveValue = ReminderNotificationCenter.shared
}
