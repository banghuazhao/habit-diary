...
class AppReviewPromptService {
    ...
    func openAppStoreReview() {
        let appID = Constants.AppID.appID
...
extension DependencyValues {
    var appReviewPromptService: AppReviewPromptService {
        get { self[AppReviewPromptServiceKey.self] }
        set { self[AppReviewPromptServiceKey.self] = newValue }
    }
}

private enum AppReviewPromptServiceKey: DependencyKey {
    static let liveValue = AppReviewPromptService()
} 
