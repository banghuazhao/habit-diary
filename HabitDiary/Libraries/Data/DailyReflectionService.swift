...
struct DailyReflectionService {
    ...
    private var quotes: [DailyReflection] {
        [
    ...
    func getRandomQuote() -> DailyReflection {
...
extension DependencyValues {
    var dailyReflectionService: DailyReflectionService {
        get { self[DailyReflectionServiceKey.self] }
        set { self[DailyReflectionServiceKey.self] = newValue }
    }
}

private enum DailyReflectionServiceKey: DependencyKey {
    static let liveValue = DailyReflectionService()
} 
