...
@Observable
final class PremiumAccessManager {
...
extension DependencyValues {
    var premiumAccessManager: PremiumAccessManager {
        get { self[PremiumAccessManagerKey.self] }
        set { self[PremiumAccessManagerKey.self] = newValue }
    }
}

private enum PremiumAccessManagerKey: DependencyKey {
    static let liveValue = PremiumAccessManager()
}
